...
export function Room(props) {
    const { nodes, materials } = useGLTF("/stmotions/models/optimized-room.glb");
    const screensRef = useRef();
    const matcapTexture = useTexture("/stmotions/images/textures/mat1.png");
...
useGLTF.preload("/stmotions/models/optimized-room.glb");
